...
class swerv_el2(pluginTemplate):
    __model__ = "swerv_el2"
    ...
    def __init__(self, *args, **kwargs):
        ...
        self.dut_exe = os.path.join(config['PATH'] if 'PATH' in config else "","swerv_el2")
    ...
    def build(self, isa_yaml, platform_yaml):
      ...
      # for swerv_el2 start building the '--isa' argument. the self.isa is dutnmae specific and may not be
      # useful for all DUTs
