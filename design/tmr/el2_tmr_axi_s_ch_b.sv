...
module el2_tmr_axi_s_ch_b # (
  ...
  el2_tmr_voter #(.Width(1)) x_voter_bvalid (
    .in_a     (m_axi_a_bvalid_i),
    .in_b     (m_axi_b_bvalid_i),
    .in_c     (m_axi_c_bvalid_i),
  ...
  el2_tmr_voter #(.Width($bits(s_axi_bresp_o))) x_voter_bresp (
    .in_a     (m_axi_a_bresp_i),
    .in_b     (m_axi_b_bresp_i),
    .in_c     (m_axi_c_bresp_i),
  ...
  assign m_axi_a_bready_o = s_axi_bready_i;
  assign m_axi_b_bready_o = s_axi_bready_i;
  assign m_axi_c_bready_o = s_axi_bready_i;
