...
* Machine Counter-Inhibit Register36 (mcountinhibit) (see Section 3.1.13 in [2])
...
:::{table} Table 7-1 List of Countable Events
...
|9|muls committed|Number of multiplications committed (IP, 0/1)|
...
|15|alus committed|Number of ALU37 operations committed (IP, 0/1)|
...
|38|timer interrupts taken|Number of timer38 interrupts taken (IP)|
