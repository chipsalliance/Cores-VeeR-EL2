...
static void __attribute__((noinline)) trigger_csr_read(uint32_t test_case, uint16_t err_id, uint8_t cmd) {
    switch (test_case) {
        case 62: INJECT_ERR(err_id, cmd); asm volatile(".rept 1000\n\t csrr x0, mscratch\n\t .endr"); tohost = CMD_INJ_CLEAR; break;
        case 63: INJECT_ERR(err_id, cmd); asm volatile(".rept 1000\n\t csrr x0, mstatus \n\t .endr"); tohost = CMD_INJ_CLEAR; break;
        case 64: INJECT_ERR(err_id, cmd); asm volatile(".rept 1000\n\t csrr x0, mtvec   \n\t .endr"); tohost = CMD_INJ_CLEAR; break;
        case 65: INJECT_ERR(err_id, cmd); asm volatile(".rept 1000\n\t csrr x0, mtval   \n\t .endr"); tohost = CMD_INJ_CLEAR; break;
        case 66: INJECT_ERR(err_id, cmd); asm volatile(".rept 1000\n\t csrr x0, mcycle  \n\t .endr"); tohost = CMD_INJ_CLEAR; break;
        case 67: INJECT_ERR(err_id, cmd); asm volatile(".rept 1000\n\t csrr x0, 0x7c0   \n\t .endr"); tohost = CMD_INJ_CLEAR; break;
        case 68: INJECT_ERR(err_id, cmd); asm volatile(".rept 1000\n\t csrr x0, mepc    \n\t .endr"); tohost = CMD_INJ_CLEAR; break;
        case 69: INJECT_ERR(err_id, cmd); asm volatile(".rept 1000\n\t csrr x0, mie     \n\t .endr"); tohost = CMD_INJ_CLEAR; break;
        case 70: INJECT_ERR(err_id, cmd); asm volatile(".rept 1000\n\t csrr x0, mcause  \n\t .endr"); tohost = CMD_INJ_CLEAR; break;
        case 71: INJECT_ERR(err_id, cmd); asm volatile(".rept 1000\n\t csrr x0, mip     \n\t .endr"); tohost = CMD_INJ_CLEAR; break;
        case 72: INJECT_ERR(err_id, cmd); asm volatile(".rept 1000\n\t csrr x0, minstret\n\t .endr"); tohost = CMD_INJ_CLEAR; break;
        default: break;
    }
}
