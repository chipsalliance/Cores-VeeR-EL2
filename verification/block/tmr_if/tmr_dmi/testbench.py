...
class BaseEnv(uvm_env):
    ...
    def build_phase(self):
        ...
        self.fault_monitor = FaultMonitor(
            ...
            clock_domain=self.clock_domain,
            signals=[
                cocotb.top.dmi_fault_q[0],
                cocotb.top.dmi_fault_q[1],
                cocotb.top.dmi_fault_q[2],
            ],
        )
...
class BaseTest(common.BaseTest):
    ...
    async def initial(self):
        ...
        cocotb.top.dmi_fault_clr[0].value = MuBiFalse
        cocotb.top.dmi_fault_clr[1].value = MuBiFalse
        cocotb.top.dmi_fault_clr[2].value = MuBiFalse
