...
class TestFaults(BaseTest):
    ...
    async def run(self):
        ...
        signals = {
            "ic_b_sb_wren_veer": None,
            "ic_b_sb_bit_en_vec_veer": None,
            "ic_sb_wr_data_veer": None,
            "ic_rw_addr_bank_q_veer": None,
            "ic_bank_way_clken_final_veer": None,
            "ic_bank_way_clken_final_up_veer": None,
            "ic_tag_clken_final_veer": None,
            "ic_tag_wren_q_veer": None,
            "ic_tag_wren_biten_vec_veer": None,
            "ic_tag_wr_data_veer": None,
            "ic_rw_addr_q_veer": None,
        }
