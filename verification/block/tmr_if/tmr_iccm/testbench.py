...
class BaseTest(common.BaseTest):
    ...
    async def initial(self):
        ...
        # Initialize
        cocotb.top.iccm_output_inhibit.value = MuBiFalse

        cocotb.top.iccm_fault_clr[0].value = MuBiFalse
        cocotb.top.iccm_fault_clr[1].value = MuBiFalse
        cocotb.top.iccm_fault_clr[2].value = MuBiFalse
