...
class FaultScoreboard(BaseScoreboard):
    ...
    def check_phase(self):
        ...
        for timestamp in timestamps:
            ...
            # Fixup one signal name
            if "dec_tlu_force_halt_int" in out_bus_state:
                out_bus_state["dec_tlu_force_halt"] = out_bus_state["dec_tlu_force_halt_int"]
                del out_bus_state["dec_tlu_force_halt_int"]
