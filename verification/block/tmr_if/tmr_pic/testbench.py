...
class BaseEnv(uvm_env):
    ...
    def build_phase(self):
        ...
        self.out_bus_monitor = BusMonitor(
            ...
            self,
            clock_domain=self.clock_domain,
            signals=[s + "_int" for s in bus_signals],
        )
        ...
        self.fault_monitor = FaultMonitor(
            ...
            clock_domain=self.clock_domain,
            signals=[
                cocotb.top.pic_fault_q[0],
                cocotb.top.pic_fault_q[1],
                cocotb.top.pic_fault_q[2],
            ],
        )
...
class BaseTest(common.BaseTest):
    ...
    async def initial(self):
        ...
        cocotb.top.pic_fault_clr[0].value = MuBiFalse
        cocotb.top.pic_fault_clr[1].value = MuBiFalse
        cocotb.top.pic_fault_clr[2].value = MuBiFalse

        cocotb.top.picm_wren_veer.value = [0] * 3
        cocotb.top.picm_rden_veer.value = [0] * 3
        cocotb.top.picm_mken_veer.value = [0] * 3
        cocotb.top.picm_rdaddr_veer.value = [0] * 3
        cocotb.top.picm_wraddr_veer.value = [0] * 3
        cocotb.top.picm_wr_data_veer.value = [0] * 3
        cocotb.top.meicurpl_veer.value = [0] * 3
        cocotb.top.meipt_veer.value = [0] * 3

        cocotb.top.picm_rd_data_int.value = 0
        cocotb.top.pic_claimid_int.value = 0
        cocotb.top.pic_pl_int.value = 0
        cocotb.top.mexintpend_int.value = 0
        cocotb.top.mhwakeup_int.value = 0
